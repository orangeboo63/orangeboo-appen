...
Contain Text
    ...
    run keyword if      '${show_text}'=='True'      Verify Content
    run keyword unless  '${show_text}'=='False'     Select Toxic Neither At None
...
Is Content Toxic
    ...
    ${status_toxic}=    set variable if     '${status}'=='True'     Toxic
...
Is Content Healthy
    ...
    \   Log     ${line}
    \   ${status}=     run keyword and return status       should contain      ${text}     ${line}
    ${status_healthy}=    set variable if     '${status}'=='True'     Healthy
...
Verify Content
    ...
    run keyword if      '${content_toxic}'=='True'       Select Toxic In Text Yes    Toxic
    ...     ELSE IF     '${content_healthy}'=='True'     Select Toxic In Text Yes    Healthy
